                                                ...
                                                {[1, 2, 3, 4].map((i) => (
                                                    <div key={i} className="relative overflow-hidden border-r border-foreground/5 last:border-r-0">
                                                        <img
                                                            ...
                                                            className="w-full h-16 object-cover transition-all duration-700 hover:scale-110 hover:brightness-110"
                                                        />
                                                        <div className={`absolute inset-0 bg-gradient-to-${i % 2 === 0 ? 'br' : 'bl'} from-accent/${i * 5} to-transparent`} />
                                                    </div>
                                                ))}
                                            </div>
                                                ...
                                                <div className="absolute inset-0 flex">
                                                    ...
                                                    <div className="relative w-1/2 overflow-hidden">
                                                        <img
                                                            ...
                                                            className="w-full h-full object-cover transition-transform duration-700 hover:scale-105"
                                                        />
                                                        <div className="absolute inset-0 bg-gradient-to-l from-accent/15 to-transparent" />
                                                    </div>
                                                </div>
